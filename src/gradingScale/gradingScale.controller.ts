...
export class GradingScaleController {
  ...
  @ApiOperation({
    ...
    description: 'Crée une nouvelle grille de notation avec ou sans critères intégrés. Supporte les types: livrable, rapport, soutenance.'
  })
  @ApiBody({ 
  ...
  @ApiOperation({
    ...
    description: 'Récupère les détails d\'une grille de notation par son ID, incluant ses critères associés.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description: 'Valide une grille de notation. Une fois validée, la grille ne peut plus être modifiée ou supprimée.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({ status: 404, description: 'Grille de notation non trouvée' })
  @ApiResponse({ status: 400, description: 'Grille déjà validée ou critères manquants' })
  ...
  @ApiOperation({
    ...
    description: 'Ajoute un nouveau critère d\'évaluation à une grille de notation existante.'
  })
  @ApiParam({
    name: 'id',
    description: 'UUID de la grille de notation',
  ...
  @ApiResponse({ status: 404, description: 'Grille de notation non trouvée' })
  @ApiResponse({ status: 403, description: 'Grille validée, modification interdite' })
  @UsePipes(new ValidationPipe())
  ...
  @ApiOperation({
    ...
    description: 'Enregistre les résultats d\'évaluation pour une grille de notation validée.'
  })
  @ApiParam({
    name: 'id',
    description: 'UUID de la grille de notation',
  ...
  @ApiResponse({ status: 404, description: 'Grille de notation non trouvée' })
  @ApiResponse({ status: 400, description: 'Grille non validée ou données invalides' })
  @UsePipes(new ValidationPipe())
  async createResults(
    @Param("id") id: string,
  ...
  @ApiOperation({
    ...
    description: 'Modifie un résultat d\'évaluation existant (score et/ou commentaire).'
  })
  @ApiParam({
    name: 'resultId',
...
export class ProjectGradingScaleController {
  ...
  @ApiOperation({
    ...
    description: 'Récupère toutes les grilles de notation associées à un projet, avec filtrage optionnel par type et targetId.'
  })
  @ApiParam({
    name: 'id',
