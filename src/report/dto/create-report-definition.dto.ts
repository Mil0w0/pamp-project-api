...
export class CreateReportDefinitionDto {
  ...
  @ApiProperty({
    example: '[{"id": 1, "text": "What was your biggest challenge?", "type": "text"}]',
    required: false,
  ...
  @IsValidReportDefinition({
    message: 'Invalid report definition: check format-specific field requirements'
  })
  private _validation?: any; // This field is just for validation, not actually used
} 