...
export class ReportDefinitionController {
  ...
  @ApiResponse({
    status: 400,
    description:
      "Bad request - Project not found or report definition already exists",
  })
  @ApiBody({
  ...
  @ApiResponse({
    status: 200,
    description:
      "The report definition for the project has been successfully fetched.",
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiResponse({
    status: 200,
    description:
      "The report definition for the project has been successfully updated.",
  })
  @ApiResponse({
    status: 404,
    description: "No report definition found for this project",
